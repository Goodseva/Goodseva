          ...
          <Form layout="vertical" form={form} style={{marginBottom:5}}>
            ...
            >
              ...
              >
                <Select
                  defaultValue="1"
                  style={{ height:44,border:"1px solid rgba(196, 196, 196, 1)",borderRadius:8}}
            ...
            <div
              ...
              >
                ...
                >
                  <Input
                    ...
                    prefix={<PhoneOutlined style={{fontSize:24,transform:"rotate(-270deg)"}}/>}
                  />
                </Form.Item>
                <Form.Item
                  label="Company Email"
                ...
                >
                  <Input type="email" prefix={<MailOutlined style={{fontSize:24}}/>} style={{height:44}} placeholder="Enter Email"/>
                </Form.Item>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  <Input type="text" style={{height:44}} placeholder="Enter GST No"/>
                </Form.Item>
              </div>
          </Form>
        </div>
        ...
        {activeTab === "post_load" && (
          <div className="content-panel">
            ...
            <div className="steps-action">
              {currentStep > 0 && (
                <Button className="back-button" onClick={handlePrevious} style={{ marginRight: 8 }}>
                  <ArrowLeftOutlined />
                </Button>
              )}
